/*
 *    This program is free software; you can redistribute i	t and/or modify
...
public class JSONNode
  ...
  public void toString(StringBuffer buffer) {
	...
	buffer.append("null");
    	  ...
    	  System.out.println("was a string!");

	buffer.append("\"");
	buffer.append(escape(m_Value));
	buffer.append("\"");
      }
      else {
    	  System.out.println("wasnt string!");
  ...
  public String toString() {
	...
	result = escape(m_Name) + " (Array)";
      ...
      if (m_Name != null){
    	  ...
    	  System.out.println("wasnt a string!");
    	  result = "" + m_Value;
      }
    }
  ...
  public static void main(String[] args) throws Exception {
    ...
    address.addPrimitive("streetAddr 10\\ % ", "ation 10\\% Ensure all major 2nd Street");
    ...
    System.out.println("streetAddr 10\\ % ation 10\\% Ensure all major 2nd Street");
    // output in console
